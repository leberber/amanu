...
export const routes: Routes = [
  ...
  { path: '', component: HomeComponent, data: { hideBottomNav: true } },
  { path: 'home', component: HomeComponent, data: { hideBottomNav: true } },
  ...
  {
    path: 'admin/returns',
    loadComponent: () => import('./pages/admin/admin-returns/admin-returns.component').then(m => m.AdminReturnsComponent),
    canActivate: [adminGuard]
  },
  {
  ...
  },
  {
    ...
    canActivate: [adminGuard],
    data: { hideBottomNav: true, createMode: true }
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/admin/admin-purchase-order-detail/admin-purchase-order-detail.component').then(m => m.AdminPurchaseOrderDetailComponent),
    canActivate: [adminGuard],
    data: { hideBottomNav: true }
  },
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/admin/admin-product-analytics/admin-product-analytics.component').then(m => m.AdminProductAnalyticsComponent),
    canActivate: [adminGuard],
    data: { hideBottomNav: true }
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/admin/admin-user-balance/admin-user-balance.component').then(m => m.AdminUserBalanceComponent),
    canActivate: [adminGuard],
    data: { hideBottomNav: true }
  },
