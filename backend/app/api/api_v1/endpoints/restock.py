...
def map_product_unit(unit: str) -> ProductUnit:
    ...
    mapping = {
        ...
        "portion": ProductUnit.PORTION,
        "slice": ProductUnit.SLICE,
        "bottle": ProductUnit.BOTTLE,
        "can": ProductUnit.CAN,
        "jar": ProductUnit.JAR,
        "sachet": ProductUnit.SACHET,
        "tray": ProductUnit.TRAY,
        "pot": ProductUnit.POT,
        "tube": ProductUnit.TUBE,
        "L": ProductUnit.LITER,
        "ml": ProductUnit.MILLILITER,
        "cl": ProductUnit.CENTILITER,
        "carton": ProductUnit.CARTON,
        "crate": ProductUnit.CRATE,
