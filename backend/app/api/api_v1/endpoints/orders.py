...
def create_order(
    ...
    order = Order(
        ...
        original_shipping_cost=order_in.original_shipping_cost,
    ...
    if current_user.role != UserRole.CUSTOMER:
        ...
        for item in order.items:
            response.items.append(OrderItemRead(
                ...
                fraction_options=item.product.fraction_options if item.product else None,
        ...
        **order.model_dump(),
        ...
        items=[
            OrderItemRead(
                ...
                fraction_options=i.product.fraction_options if i.product else None,
